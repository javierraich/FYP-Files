...
if __name__ == '__main__':
    ...
    for i in range(listLength):
        ...
        tenFirst = torch.FloatTensor(numpy.ascontiguousarray(numpy.array(PIL.Image.open(listPast[i]))[:, :, ::-1].transpose(2, 0, 1).astype(numpy.float32) * (1.0 / 255.0)))
        tenSecond = torch.FloatTensor(numpy.ascontiguousarray(numpy.array(PIL.Image.open(listPresent[i]))[:, :, ::-1].transpose(2, 0, 1).astype(numpy.float32) * (1.0 / 255.0)))
        ...
        fullName = 'C:\\Users\\Javier R\\Desktop\\FYPFiles\\PWCNET\\CalculatedFlows\\ValidationCenter\\' + baseName + '.mat'

        with open(r"C:\Users\Javier R\Desktop\FYPFiles\PWCNET\pytorch-pwc\out.flo", 'rb') as f:
            magic, = numpy.fromfile(f, numpy.float32, count=1)
            if 202021.25 != magic:
                print('Magic number incorrect. Invalid .flo file')
            else:
                w, h = numpy.fromfile(f, numpy.int32, count=2)
                #print(f'Reading {w} x {h} flo file')
                data = numpy.fromfile(f, numpy.float32, count=2*w*h)
                # Reshape data into 3D array (columns, rows, bands)
                data2D = numpy.resize(data, (w, h, 2))
                #print(data2D.shape)

                horizontalComponent = data2D[: , : , 0]
                verticalComponent = data2D[: , : , 1]
    ...
    for i in range(listLength):
        ...
        fullName = 'C:\\Users\\Javier R\\Desktop\\FYPFiles\\PWCNET\\CalculatedFlows\\ValidationRight\\' + baseName + '.mat'
    ...
    for i in range(listLength):
        ...
        fullName = 'C:\\Users\\Javier R\\Desktop\\FYPFiles\\PWCNET\\CalculatedFlows\\ValidationLeft\\' + baseName + '.mat'
    ...
    for i in range(listLength):
        ...
        fullName = 'C:\\Users\\Javier R\\Desktop\\FYPFiles\\PWCNET\\CalculatedFlows\\TrainingCenter\\' + baseName + '.mat'
    ...
    for i in range(listLength):
        ...
        fullName = 'C:\\Users\\Javier R\\Desktop\\FYPFiles\\PWCNET\\CalculatedFlows\\TrainingRight\\' + baseName + '.mat'
    ...
    for i in range(listLength):
        ...
        fullName = 'C:\\Users\\Javier R\\Desktop\\FYPFiles\\PWCNET\\CalculatedFlows\\TrainingLeft\\' + baseName + '.mat'
